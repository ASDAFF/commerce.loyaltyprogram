...
class CommerceBonusEvent {
	...
	updateBonusAdded(){
		if(!CommerceBonusEventHandler.bonusAdded){
			CommerceBonusEventHandler.bonusAdded=0;
			BX.ajax({  
				url: '/bitrix/components/commerce/order.ajax.bonus/ajax.php',
					...
					onsuccess: function(data){
						CommerceBonusEventHandler.bonusAdded=data;
						...
						if(CommerceBonusEventHandler.bonusAdded.bonus>0){
							let addedBlock=
								BX.create('DIV', {
									...
									children:[
										...
										BX.create('SPAN', {
											...
											html: CommerceBonusEventHandler.bonusAdded.bonus_format,
										})
									]
								});
	...
	setBonusHandler() {
		CommerceBonusEventHandler.updateBonusAdded();
