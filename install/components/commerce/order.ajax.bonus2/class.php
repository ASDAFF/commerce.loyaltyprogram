...
class Commerce_OrderAjaxBonus2 extends \CBitrixComponent{
	public function onPrepareComponentParams($params){
		...
		$params['MESS_HASBONUSADDED']=(empty($params['MESS_HASBONUSADDED'])?Loc::getMessage('commerce.bonus_hasbonusAdded'):$params['MESS_HASBONUSADDED']);
		return $params;
	}
